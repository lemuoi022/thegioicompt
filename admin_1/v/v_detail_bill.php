...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-9">
                <?php if ($user[0]['lv'] == 1) { ?>
                    ...
                    <a href="?controller=handle_order&method=browse&id=<?php echo $value['id'] ?>" class="btn btn-success" style="font-size: 15px;">Duyệt</a><br><br>
                    <?php } } ?>
            </div>
        <?php } ?>
        <!-- Content Row -->
        ...
        <div><a href="?controller=bill" class="btn btn-success" style="text-decoration: none;">Back</a></div>
        <!-- End of Main Content -->
