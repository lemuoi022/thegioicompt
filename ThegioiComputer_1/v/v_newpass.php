    ...
    <main class="login-form">
        <div class="cotainer">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">Mật khẩu mới</div>
                        <div class="card-body">
                            <form action="?controller=newpass" method="post">
                                ...
                                ?>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="form-group row">
                                                <label for="password1" class="col-md-4 col-form-label text-md-right">Mật khẩu mới</label>
                                                <div class="col-md-6">
                                            ...
                                            <div class="col-md-12 text-center" style="color: red;">
                                                <p class=""><?php if (!empty($error)) echo $error ?></p>
                                            </div>
                                        </div>
                                        <div class="col-md-6 offset-md-4">
                                            <button type="submit" class="btn btn-primary" value="btn-newpass" name="btn-newpass">
                                                Đổi mật khẩu
                                            </button>
